...
param (
    ...
    $GitHubUserName = "BonQerss", # Name of the GitHub user where the mod is contained
    $GitHubRepoName = "p3ppc.expandedsubmenu", # Name of the GitHub repo where the mod is contained
